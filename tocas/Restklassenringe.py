...
class RestklassenringElement(RingElement):
    ...
    def __init__(self, a, n):
        ...
        if isinstance(n, int):
            ...
            raise RuntimeError(
                "Das zweite angegebene Objekt ist keine Zahl und kein Restklassenring.")
        ...
        if type(a) == int:
            ...
            raise RuntimeError(
                "Das erste angegebene Objekt ist keine Zahl und kein Restklassenringelement.")
    ...
    def __rmul__(self, other):
        ...
        if type(other) == int:
            ...
            raise RuntimeError(
                "Die Elemente können nicht multipliziert werden.")
    ...
    def invers(self):
        ...
        u, s = RestklassenringElement(
            1, self.ring), RestklassenringElement(0, self.ring)
