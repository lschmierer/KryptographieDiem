...
zu validieren, wurden Laufzeitmessungen durchgeführt. Alle Berechnungen wurden auf dem Rechenserver \emph{miserv100} der Universität Leipzig ausgeführt ($12$ Kerne mit $3.07$ GHz, $196$ GB RAM).
...
\begin{table}[h]
  ...
  \begin{tabular}{l|c|c|c}
    %Hier mal noch die alten Messwerte!
    ...
    Methode             & min   & max   & avg   \\ \hline
    Rho (Floyd)         & 1.440 & 4.147 & 2.349  \\ \hline
    Rho (Brent)         & 1.351 & 3.563 & 2.173 \\ \hline
    Rho (Distinguished) & 1.298 & 2.283 & 1.8611 \\ \hline
    Känguru             & 2.543 & 2.680 & 2.583
    \end{tabular}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{../projekt/benchmark/plot_miserv_dlp.png}
...
Für dessen Validierung wurde der selbe diskrete Logarithmus aus dem vorherigen Kapitel berechnet, mit der gleichen Anzahl an Wiederholungen.
Die Berechnungen wurden wieder auf \emph{miserv100} ausgeführt.
Dabei wurden 2 verschiedene Parallelisierungsgrade mit 6 und 11 Threads verwendet. 
Die Messergebnisse sind in Tabelle \ref{tab:benchmark:parallel} dargestellt und in Abbildung \ref{fig:benchmark:parallel} als Boxplot visualisiert. \\
Es ist eine deutliche Beschleunigung der Laufzeit zu beobachten
...
\begin{table}[h]
  ...
  \begin{tabular}{l|c|c|c}
    Methode             & min   & max   & avg   \\ \hline
    Rho (Distinguished) & 0,776 & 2,149 & 1,281 \\ \hline
    Rho (parallel, 6 Threads) & 0,776 & 2,149 & 1,281 \\ \hline
    Rho (parallel, 11 Threads) & 0,776 & 2,149 & 1,281 \\ \hline
    \end{tabular}
...
\begin{figure}[h]
  \centering
  \includegraphics[width=0.6\textwidth]{../projekt/benchmark/plot_miserv_parallel.png}
