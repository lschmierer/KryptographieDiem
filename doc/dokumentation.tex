...
Dadurch eignet sie sich besser für die Berechnung des DLP auf aktuelle Computer-Hardware.
...
orientiert.
Unsere Implementierungen ist in der Datei \emph{rho.py} zu finden.

\subsubsection{Walk Funktion}
\label{sec:walk_funktion}
Es wurden zwei verschiende \emph{walk}-Funktionen implementiert.
Diese sind Pollards originaler rho walk und der additive rho walk.
...
Alle Zyklussuch-Methoden können mit beiden Walk Funktionen genutztz werden.
...
Sie arbeitet auch mit distinguished points.
Unsere Implementierung ist in der Datei \emph{kaenguru.py} zu finden.
\cite{Galbraith2012}
